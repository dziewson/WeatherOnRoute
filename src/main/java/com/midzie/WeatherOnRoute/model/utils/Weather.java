...
public class Weather {
	...
	private List<NextDaysWeather> nextDaysWeather = new ArrayList<>();
	...
	public List<NextDaysWeather> getNextDaysWeather() {
		return nextDaysWeather;
	}

	public void setNextDaysWeather(List<NextDaysWeather> nextDaysWeather) {
	...
	public String toString() {
		return "Weather [city=" + city + ", country=" + country + ", windSpeed=" + windSpeed + ", windDirection="
				...
				+ ", temperature=" + temperature + ", description=" + description + ", nextDaysWeather="
				+ nextDaysWeather + "]";
	}
